...
export const EventsTable = (properties: { events: readonly UsageEvent[]; }) => (
  <Show
            ...
            {record => (
              <tr class="hover:bg-raised">
                ...
                <td class={[CELL, "max-w-72"]}>
                  <AccountName account={record.account} />
                </td>
                ...
                >
                  {formatCost(record.list_cost_usd)}
                </td>
                <td
                  class={[
                    CELL,
                ...
                >
                  {formatCost(record.billed_cost_usd)}
                </td>
